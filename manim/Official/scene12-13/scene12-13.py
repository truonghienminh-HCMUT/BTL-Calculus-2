...
class ChiaNho(MovingCameraScene):
    def construct(self):
        ...
        self.play(Unwrite(text_6_copy_scene12), Unwrite(text_8_copy_scene12), Uncreate(axes1_labels_scene12), Uncreate(axes2_labels_scene12), Unwrite(half_circle_equation1_scene12),
                Unwrite(half_circle_equation2_scene12), Unwrite(equation_scene12), Uncreate(axes1_labels_scene12), Uncreate(axes2_labels_scene12), Uncreate(axes1_scene12), Uncreate(axes2_scene12))
       ...
       #SỐ CỦA TRỤC TỌA ĐỘ
        ...
        #CHẠY SCENE13
        self.play(Transform(text_scene12, Text_1_scene13[0]), Write(Text_1_scene13[1]), run_time=2)
        ...
        self.wait(1)
        self.play(Uncreate(Text_1_scene13), Uncreate(text_scene12))
